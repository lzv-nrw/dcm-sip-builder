"""
- DCM SIP Builder -
This flask app implements the 'SIP Builder'-API (see
`openapi.yaml` in the sibling-package `dcm_sip_builder_api`).
"""
...
def app_factory(
    ...
    app.extensions["orchestra"] = extensions.orchestra_loader(
        app, config, config.worker_pool, "SIP Builder", as_process
    )
